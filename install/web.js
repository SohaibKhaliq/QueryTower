...
async function launch() {
	try {
		...
		if (!nconf.get('launchCmd')) {
			...
			console.log('\nStarting QueryTower');
			console.log('    "./QueryTower stop" to stop the QueryTower server');
			console.log('    "./QueryTower log" to view server output');
			console.log('    "./QueryTower restart" to restart QueryTower');
		} else {
