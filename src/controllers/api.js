...
apiController.loadConfig = async function (req) {
	const config = {
		...
		siteTitle: validator.escape(String(meta.config.title || meta.config.browserTitle || 'QueryTower')),
		browserTitle: validator.escape(String(meta.config.browserTitle || meta.config.title || 'QueryTower')),
