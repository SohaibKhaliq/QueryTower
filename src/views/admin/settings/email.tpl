		...
		<div id="spy-container" class="col-12 col-md-8 px-0 mb-4" tabindex="0">
			<div id="email-settings" class="mb-4">
				...
				<div class="mb-3">
					...
					<input type="text" class="form-control input-lg" id="email:from" data-field="email:from" placeholder="info@querytower.org" />
				</div>

				<div class="mb-3">
					<label class="form-label" for="email:from_name">[[admin/settings/email:from]]</label>
					<input type="text" class="form-control input-lg" id="email:from_name" data-field="email:from_name" placeholder="QueryTower" />
